...
export default function ContactListPage() {
  ...
  const sample = [
    { id: 1, name: 'Ana Pérez', phone: '+51 912 345 678', email: 'ana@example.com' },
    { id: 2, name: 'Luis Gómez', phone: '+51 988 123 456', email: 'luis@example.com' },
    { id: 3, name: 'María Ruiz', phone: '+51 999 222 333', email: 'maria@example.com' },
    { id: 4, name: 'Carlos Soto', phone: '+51 977 111 222', email: 'carlos@example.com' },
