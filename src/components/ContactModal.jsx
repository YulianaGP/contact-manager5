  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center px-4">
      ...
      <form onSubmit={handleSave} className="relative z-10 w-full max-w-md bg-white dark:bg-slate-800 rounded-lg p-6 shadow-lg">
        <button type="button" onClick={closeCreate} className="absolute right-3 top-3 text-slate-700 dark:text-slate-200 hover:opacity-80 text-2xl">×</button>
        ...
        <div className="mt-5 flex justify-end gap-3">
          <button type="button" onClick={closeCreate} className="px-3 py-2 rounded-md bg-slate-100 dark:bg-slate-700 text-sm hover:bg-slate-200 dark:hover:bg-slate-600">Cancel</button>
